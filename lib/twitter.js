...
Twitter.prototype.get = function(url, params) {
  return new Promise(function(resolve, reject) {
    this.__request('get', url, params, function(error, data, response) {
      if (error) {
        reject(error);
        return;
      }
...
Twitter.prototype.post = function(url, params) {
  return new Promise(function(resolve, reject) {
    this.__request('post', url, params, function(error, data, response) {
      if (error) {
        reject(error);
        return;
      }
 ...
 * STREAM
 */
Twitter.prototype.stream = function (method, params) {
  return new Promise(function(resolve, reject) {
    params = params || {};
